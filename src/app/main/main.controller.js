(function() {
  ...
  angular
    .module('hosen')
    .controller('MainController', ['$scope', '$location', '$anchorScroll', 'AuthenticationService', '$rootScope' , '$http', '$window',
  function ($scope, $location, $anchorScroll, AuthenticationService, $rootScope, $http, $window) {
